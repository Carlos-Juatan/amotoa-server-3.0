...
- List of modified principles:
  - PRINCIPLE 1: Updated to exclude MongoDB from docker-compose.yml, requiring it to run externally and be accessed via MONGODB_URI from the .env file.
- Added sections: None
...
2. **Backend & Database Initialization**: Setup baseline FastAPI app structure using App Factories, modular database service factories connecting to external MongoDB via MONGODB_URI, and configuration collections.
